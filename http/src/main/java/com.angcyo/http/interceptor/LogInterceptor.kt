...
open class LogInterceptor : Interceptor {
    ...
    companion object {
        ...
        /**关闭日志*/
        fun closeLog(close: Boolean = !L.isDebug) = HEADER_LOG to "${!close}"
...
/**关闭日志*/
fun Request.Builder.closeLog(close: Boolean = !L.isDebug): Request.Builder {
