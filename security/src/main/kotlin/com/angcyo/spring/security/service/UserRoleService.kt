...
import com.angcyo.spring.mybatis.plus.auto.annotation.AutoFillRefs
...
class UserRoleService : BaseAutoMybatisServiceImpl<IUserRoleMapper, UserRoleReTable>() {
    ...
    /**获取用户对应的角色列表*/
    @AutoFillRefs(["com.angcyo.spring.security.bean.UserDetail.getUserRoleList", "com.angcyo.spring.security.bean.AuthRepBean"])
